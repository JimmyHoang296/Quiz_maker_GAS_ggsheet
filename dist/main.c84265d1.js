...
startBtn.addEventListener("click", function () {
  ...
  var testTime = 10;
  var display = document.querySelector('.counting-clock');
...
function renderQA(qa) {
  ...
  Object.keys(qa).forEach(function (key) {
    var quest = qa[key];
    wrapper.innerHTML = wrapper.innerHTML + "\n        <div class=\"qa\">\n            <h2 class=\"question\" id=\"".concat(quest.id, "\">").concat(quest.question, "</h2>\n            <form class=\"answers\">\n                <div class=\"answer\">\n                    <input type=\"radio\" name=\"q_").concat(quest.id, "\" id=\"").concat(quest.id, "a\">\n                    <label for=\"").concat(quest.id, "a\">").concat(quest.a, "</label>\n                </div>\n                <div class=\"answer\">\n                    <input type=\"radio\" name=\"q_").concat(quest.id, "\" id=\"").concat(quest.id, "b\">\n                    <label for=\"").concat(quest.id, "b\">").concat(quest.b, "</label>\n                </div>\n                <div class=\"answer\">\n                    <input type=\"radio\" name=\"q_").concat(quest.id, "\" id=\"").concat(quest.id, "c\">\n                    <label for=\"").concat(quest.id, "c\">").concat(quest.c, "</label>\n                </div>\n                <div class=\"answer\">\n                    <input type=\"radio\" name=\"q_").concat(quest.id, "\" id=\"").concat(quest.id, "d\">\n                    <label for=\"").concat(quest.id, "d\">").concat(quest.d, "</label>\n                </div>\n            </div>\n        </div>\n        ");
  });
  wrapper.innerHTML = wrapper.innerHTML + "\n    <button id=\"submit\">N\u1ED9p b\xE0i</button>\n  ";
}
