...
var empName, empID, empDept; // prevent refresh when submit form
...
test.addEventListener("submit", handleForm); // start test
...
startBtn.addEventListener("click", function () {
  ...
  var promiseRender = new Promise(function () {
