...
var isSubmited = false; // base infor
...
function renderQA(qa) {
  ...
  var inputs = _toConsumableArray(test.getElementsByTagName('input'));
...
function getScore(score) {
  ...
  resultDisplay.innerHTML = "B\u1EA1n \u0111\xE3 ho\xE0n th\xE0nh b\xE0i ki\u1EC3m tra v\xE0 \u0111\xFAng ".concat(score, "/").concat(quesNumber, " c\xE2u");
  modalElement.style.display = "unset";
}
...
function countAnswer() {
  ...
  var counter = 0;
  qas.forEach(function (qa) {
    var answers = _toConsumableArray(qa.getElementsByTagName('input'));
